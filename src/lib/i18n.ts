...
const en = {
  ...
  dash: {
    ...
    import: {
      ...
      summarySub: "{{created}} created · {{updated}} updated · {{errors}} errors · {{total}} rows processed",
...
const es = {
  ...
  dash: {
    ...
    import: {
      ...
      adminSub: "Elige un vendedor y sube su CSV. Los slugs existentes se actualizan para ese vendedor.",
      ...
      summarySub: "{{created}} creadas · {{updated}} actualizadas · {{errors}} errores · {{total}} filas procesadas",
