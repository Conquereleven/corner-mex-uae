    ...
    <div className="mx-auto max-w-6xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Create a CornerMex product directly. New products start as drafts until variants and
          pricing are ready.
        </p>
      </div>
      ...
      {categories.isError ? (
        <p className="text-sm text-destructive">Categories could not be loaded.</p>
      ) : null}
