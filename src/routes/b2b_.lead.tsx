...
export const Route = createFileRoute("/b2b_/lead")({
  head: () => ({
    meta: [
      { title: "Business enquiry — Intermex UAE" },
      {
        name: "description",
        content:
          "Submit a structured Intermex B2B enquiry through the quote builder or contact the team manually by email.",
      },
  ...
  return (
    <SiteLayout>
      <section className="mx-auto max-w-xl px-4 py-24 text-center sm:px-6">
        ...
        <h1 className="mt-3 font-display text-4xl tracking-tight">Request a Intermex B2B quote</h1>
        <p className="mt-5 text-base leading-7 text-muted-foreground">
          Use the B2B catalogue to select products and submit a structured enquiry directly to the
          Intermex commercial pipeline. Every request is reviewed by a person before pricing,
